...
CREATE TABLE plotHighCards(
    ...
    FOREIGN KEY (highCardID) REFERENCES highCards(ID)
...
INSERT INTO highPlotPoints (plotName, plotReading) VALUES ('Strahds Enemy','This card sheds light on one who will help you greatly in the battle against darkness.');
INSERT INTO highPlotPoints (plotName, plotReading) VALUES ('Strahds Location','Your enemy is a creature of darkness, whose powers are beyond mortality. This card will lead you to him!');

INSERT INTO lowCards (cardName, cardReading) VALUES ('1 OF SWORDS - AVENGER','The treasure lies in a dragons house, in hands once clean and now corrupted.');
...
INSERT INTO lowCards (cardName, cardReading) VALUES ('6 OF SWORDS - BERSERKER ','Find the Mad Dogs crypt. The treasure lies within, beneath blackened bones.');
...
INSERT INTO lowCards (cardName, cardReading) VALUES ('MASTER OF SWORDS - WARRIOR','That which you seek lies in the womb of darkness, the devils lair: the one place to which he must return.');
...
INSERT INTO lowCards (cardName, cardReading) VALUES ('MASTER OF STARS - WIZARD','Look for a wizards tower on a lake. Let the wizards name and servant guide you to that which you seek.');
...
INSERT INTO lowCards (cardName, cardReading) VALUES ('8 OF COINS - TAX COLLECTOR','The Vistani have what you seek. A missing child holds the key to the treasures release.');
...
INSERT INTO plotHighCards (plotID, highCardID, cardReading) VALUES (1,7,'I see a fallen paladin of a fallen order of knights. Helingers like a ghost in a dead dragons lair.');
INSERT INTO plotHighCards (plotID, highCardID, cardReading) VALUES (1,8,'Seek out the brother of the devils bride. They call him the lesser, but he has a powerful soul.');
INSERT INTO plotHighCards (plotID, highCardID, cardReading) VALUES (1,9,'I see a dead man of noble birth, guarded by his widow. Return life to the dead mans corpse, and he will be your staunch ally.');
INSERT INTO plotHighCards (plotID, highCardID, cardReading) VALUES (1,10,'Evils bride is the one you seek!');
...
INSERT INTO plotHighCards (plotID, highCardID, cardReading) VALUES (1,12,'A Vistana wanders this land alone, searching for her mentor. She does not stay in one place for long. Seek her out at Saint Markovias abbey, near the mists.');
...
INSERT INTO plotHighCards (plotID, highCardID, cardReading) VALUES (2,7,'Look to the fathers tomb.');
...
INSERT INTO plotHighCards (plotID, highCardID, cardReading) VALUES (2,12,'The cards cant see where the evil lurks. The mists obscure all!');
INSERT INTO plotHighCards (plotID, highCardID, cardReading) VALUES (2,13,'Look to the mothers tomb.');
